...
public class TC024 {
	...
	@Test
	public void testWorkExperienceSectionInputValidation() {
		...
		content.setExperience("1. SDET in cognizant");
		content.next();
		...
		Assert.assertEquals(imageButton.getAttribute("data-state"), "active",
				"Work Experience section did not accepted valid data");
		System.out.println("Work Experience section accepted valid data");
	}
